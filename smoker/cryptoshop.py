...
phoy=["AgACAgQAAxkBAAIBrWKI8ObwV_ogcBuDF5NC3ysfO36sAAJ3uTEb8dhIUGu41tIcrbqLAQADAgADeQADJAQ"]
BUTTON,AB,DES,ABAD,DESAD,CATEGORY,CATEGORYAD,PR,PRAD,PD,PID,CART,DELETE,PHO,PHOAD,MODIFY,PIDAD,CH,SH,WA,SHO,JE,ADDRESS,STOCK,PHOSTOCK,DESSTOCK,PIDSTOCK,PRSTOCK,CATEGORYSTOCK,PDSTOCK,HAM,AMAN,RMAN,AMO,TRC,CRP,FCAT,TYPP,MODF,MODFF,AKEY,COU,COD,DEL,FAQ,C1,C2,C3,C4,ADFILE,ADFILEE= range(51) 
man=[]
def start(update, context):
  ...
  if usa == "807516030" or usa == "1394902938" or usa =="993953033" or usa in man:
...
def main():
  updater = Updater("2112890317:AAEECFO5NbgqVIaQ0PArjSAeEl2nkq99fQM", use_context=True)
